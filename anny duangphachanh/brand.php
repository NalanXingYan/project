...
<center>
  <div class="you">
  <a class="youin" href="b_insert.php">Add New Brand</a>
				...
				<?php
					...
					while($row=mysqli_fetch_array($query)){
                        ...
                        <td><?php echo $row['type']; ?></td>
							<td>
								<a class="youu" href="b_edit.php?id=<?php echo $row['id']; ?>">Edit</a>
							</td>
							<td><a class="youn" href="b_delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
						</tr>
						<?php
					}
				?>
